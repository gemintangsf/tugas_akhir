...
function DaftarPenggalanganDanaBencana() {
	const cardList = [
	...
	return (
		<Container>
			<Typography fontWeight='bold' variant='h3' sx={{ mt: 2, color: '#212121' }}>Daftar Penggalangan Dana Bencana</Typography>
...
export default DaftarPenggalanganDanaBencana;