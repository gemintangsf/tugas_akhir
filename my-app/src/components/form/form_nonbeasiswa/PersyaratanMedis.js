		...
		<Container sx={{ display: 'flex' }}>
			<Box sx={{ width: '70%', display: 'flex', justifyContent: 'space-between' }}>
				...
				<Box sx={{ minWidth: '50%', display: 'flex', flexDirection: 'column', mt: 4 }}>
					...
					<div>
						<Button href='http://localhost:3000/form-nonbeasiswa/penanggungjawab/persyaratan-medis/info-galang-dana' size="medium" variant="contained" sx={{ mt: 4, textTransform: 'capitalize' }}>Selanjutnya</Button>
...
export default PersyaratanMedis;